...
def printStatisticsDetection(options, statistics):
    if not os.path.exists('logs'):
        ...
        pass
    if(options.dataFolder == 'scan_curve'):
        log_file = 'logs/global_curve.txt'
    elif(options.dataFolder == 'scan_plane'):
        log_file = 'logs/global_plane.txt'
    else:
        log_file = 'logs/global.txt'
    ...
    if not os.path.exists(log_file):
        ...
        open_type = 'a'
        pass
    with open(log_file, open_type) as f:
